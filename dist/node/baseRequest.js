...
var _excluded = ["jsonBody", "query", "urlTemplateSpec"];
var fetch = (0, _fetchPonyfill.default)(_es6Promise.Promise);
...
function baseRequest(url) {
  ...
  var requestTimeout = arguments.length > 2 ? arguments[2] : undefined;
  var jsonBody = _ref.jsonBody,
      query = _ref.query,
      urlTemplateSpec = _ref.urlTemplateSpec,
      fetchConfig = (0, _objectWithoutProperties2.default)(_ref, _excluded);
  var expandedUrl = url;
  ...
  if (urlTemplateSpec != null) {
    ...
    } else if (urlTemplateSpec && (0, _typeof2.default)(urlTemplateSpec) === 'object' && (0, _keys.default)(urlTemplateSpec).length) {
  ...
  if (query != null) {
    if (typeof query === 'string') {
      expandedUrl += query;
    } else if (query && (0, _typeof2.default)(query) === 'object') {
